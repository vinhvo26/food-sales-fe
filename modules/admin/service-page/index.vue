    ...
    <NuxtLayout name="admin">
      <div class="news-main">
        ...
        <div class="flex mt-3 search-user flex-wrap gap-4">
          <div class="w-64">
            <label for="">Tìm kiếm dịch vụ</label>
            <UInput
              v-model="key"
              size="lg"
              variant="outline"
        ...
        <div class="table-news">
          ...
          >
            ...
            <template #action-data="{ row }">
              ...
              >
                <UButton
                  :to="PATH.ADMIN_SERVICE + `/${row.slug}`"
      ...
      <ModalConfirm
        :message="
          statusChange === NewsStatus.ACTIVE
            ...
            : statusChange === NewsStatus.DELETE
            ? 'Bạn có chắc xoá bài dịch vụ này không?'
